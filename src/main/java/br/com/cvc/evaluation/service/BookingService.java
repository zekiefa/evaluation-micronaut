...
public class BookingService {
    ...
    public Optional<Hotel> getHotelDetails(final Integer codeHotel) {
        ...
        final var hotelDetails = this.brokerService.getHotelDetails(codeHotel).body();
    ...
    public List<Hotel> findHotels(final Integer cityCode, final LocalDate checkin, final LocalDate checkout,
        ...
        final var hotels = this.brokerService.findHotelsByCity(cityCode).body();
        if (Optional.ofNullable(hotels).isEmpty()) {
